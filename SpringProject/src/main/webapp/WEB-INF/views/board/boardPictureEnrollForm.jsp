			...
			<form id="enrollForm" action="${contextPath }/board/insert/${boardCode }" enctype="multipart/form-data" method="post">
				<table align="center">
					...
					<tr>
						...
						<input type="file" name="images" class="form-control" accept="images/*" id="img1"><span class="delete-image">&times;</span></td>
					</tr>
					<tr>
						...
						<input type="file" name="images" class="form-control" accept="images/*" id="img2"><span class="delete-image">&times;</span></td>
					</tr>
					<tr>
						<th><label for="image">업로드 이미지3</label></th>
						<td>						
						<img class="preview" src="${img2 }">
						<input type="file" name="images" class="form-control" accept="images/*" id="img3"><span class="delete-image">&times;</span></td>
					</tr>
					<tr>
						<th><label for="image">업로드 이미지4</label></th>
						<td>
						<img class="preview" src="${img3 }">						
						<input type="file" name="images" class="form-control" accept="images/*" id="img4"><span class="delete-image">&times;</span></td>
					</tr>
		...
		for(let i=0; i<deleteImage.length; i++){
			...
			deleteImage[i].addEventListener("click", function(){
				...
				if(preview[i].getAttribute("src") != ""){
					...
					// Array.forom(유사배열 | 컬렉션) : 배열로 변환해서 반환
